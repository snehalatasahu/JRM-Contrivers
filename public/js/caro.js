...
function scrollFunction() {
  if (document.body.scrollTop > screen.availHeight*0.85|| document.documentElement.scrollTop > screen.availHeight*0.85) {
    $("nav").append(new_nav);
  }
  else {
    $("nav").append(old_nav);
...
var fadeOut = `
<style>
.gallery-inner{animation: fadeout ;animation-duration: 1s;display: inline;}
@keyframes fadeout{
    from{opacity: 1;}
    to{opacity:0;display:none;}
}
.gallery-pics img{filter: brightness(100%);animation: darker;animation-duration: 1s;}
@keyframes darker{
